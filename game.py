...
class Solitaire:
    ...
    def __init__(self, spacing, tableau_spacing):
        ...
        pygame.display.set_caption("ПасьянсУчебнаяПрактика")
    ...
    def update(self):
        ...
        for event in pygame.event.get():
            ...
            if str(self.foundations) == '[<FoundationPile(13 sprites)>, <FoundationPile(13 sprites)>, <FoundationPile(13 sprites)>, <FoundationPile(13 sprites)>]':
                self.should_quit = True
